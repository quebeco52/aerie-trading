...
function initStockPage() {
    ...
    function parseSubActionPillsJs(text) {
        ...
        lines.forEach(rawLine => {
            ...
            if (bbMatch) {
                ...
                pills.push({
                    ...
                    text: `Repurchased ${formatSharesJs(count)} shares`,
    ...
    function renderEvents(events) {
        ...
        events.forEach(evt => {
            ...
            if (type === 'EARNINGS') {
                ...
                cardData.pills = parseSubActionPillsJs(remaining);
