 ...
 */
final class Version20260809085911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE debt_tranches (id INT AUTO_INCREMENT NOT NULL, principal NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, interest_rate NUMERIC(8, 6) DEFAULT \'0.000000\' NOT NULL, is_floating TINYINT DEFAULT 0 NOT NULL, maturity_quarter INT NOT NULL, issued_at DATETIME NOT NULL, stock_id INT NOT NULL, INDEX IDX_23A85F44DCD6110 (stock_id), INDEX idx_stock_maturity (stock_id, maturity_quarter), INDEX idx_stock_rate (stock_id, interest_rate), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
