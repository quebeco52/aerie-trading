 ...
 */
final class Version20260420203157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD revenue NUMERIC(20, 4) NOT NULL, ADD interest_income NUMERIC(20, 4) NOT NULL, ADD capital_expenditures NUMERIC(20, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP revenue, DROP interest_income, DROP capital_expenditures');
