 ...
 */
final class Version20260821220711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD total_factor_productivity_index NUMERIC(10, 4) NOT NULL, ADD total_factor_productivity_index_ema NUMERIC(10, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP total_factor_productivity_index, DROP total_factor_productivity_index_ema');
