 ...
 */
final class Version20260528111058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD deposit_apy NUMERIC(10, 4) DEFAULT NULL, ADD cash_yield NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP deposit_apy, DROP cash_yield');
