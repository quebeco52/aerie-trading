 ...
 */
final class Version20260909103814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD term_premium_shock NUMERIC(10, 4) DEFAULT NULL, ADD term_premium_regime NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP term_premium_shock, DROP term_premium_regime');
