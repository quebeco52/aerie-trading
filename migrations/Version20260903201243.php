 ...
 */
final class Version20260903201243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD nairu NUMERIC(10, 4) DEFAULT NULL, ADD nairu_ema NUMERIC(10, 4) DEFAULT NULL, ADD sovereign_debt_to_gdp NUMERIC(10, 4) DEFAULT NULL, ADD sovereign_debt_to_gdp_ema NUMERIC(10, 4) DEFAULT NULL, ADD financial_conditions_index NUMERIC(10, 4) DEFAULT NULL, ADD financial_conditions_index_ema NUMERIC(10, 4) DEFAULT NULL, ADD agri_cost_push_lag NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP nairu, DROP nairu_ema, DROP sovereign_debt_to_gdp, DROP sovereign_debt_to_gdp_ema, DROP financial_conditions_index, DROP financial_conditions_index_ema, DROP agri_cost_push_lag');
