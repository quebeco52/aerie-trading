 ...
 */
final class Version20260807152216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD is_audited TINYINT DEFAULT 0 NOT NULL, ADD revenue_streams JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP is_audited, DROP revenue_streams');
