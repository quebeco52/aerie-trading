 ...
 */
final class Version20260910085023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dividend_payment (id INT AUTO_INCREMENT NOT NULL, asset_type VARCHAR(10) NOT NULL, ticker VARCHAR(10) NOT NULL, shares_held BIGINT NOT NULL, dividend_per_share NUMERIC(15, 4) NOT NULL, amount NUMERIC(15, 2) NOT NULL, paid_at DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_1678C3E3A76ED395 (user_id), INDEX idx_dividend_user_paid (user_id, paid_at), INDEX idx_dividend_user_ticker (user_id, ticker), UNIQUE INDEX uniq_dividend_user_ticker_paid (user_id, ticker, paid_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE dividend_payment ADD CONSTRAINT FK_1678C3E3A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dividend_payment DROP FOREIGN KEY FK_1678C3E3A76ED395');
