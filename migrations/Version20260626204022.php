 ...
 */
final class Version20260626204022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD macro_credit_spread NUMERIC(10, 4) DEFAULT NULL, ADD macro_credit_spread_ema NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP macro_credit_spread, DROP macro_credit_spread_ema');
