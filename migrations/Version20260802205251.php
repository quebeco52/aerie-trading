 ...
 */
final class Version20260802205251 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analyst_coverage (virtual_analyst_id BINARY(16) NOT NULL, stock_id INT NOT NULL, INDEX IDX_ED5A0FFF8DC954D (virtual_analyst_id), INDEX IDX_ED5A0FFFDCD6110 (stock_id), PRIMARY KEY (virtual_analyst_id, stock_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_uca1400_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE analyst_forecasts (id BINARY(16) NOT NULL, expected_revenue NUMERIC(20, 4) NOT NULL, expected_eps NUMERIC(15, 4) NOT NULL, rating VARCHAR(16) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, created_at DATETIME NOT NULL, analyst_id BINARY(16) NOT NULL, stock_id INT NOT NULL, INDEX idx_forecast_stock (stock_id), INDEX IDX_9D4F8D5BF65B3645 (analyst_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_uca1400_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE virtual_analysts (id BINARY(16) NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, bias NUMERIC(5, 4) NOT NULL, conviction NUMERIC(5, 4) NOT NULL, accuracy_rating NUMERIC(5, 4) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_uca1400_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
