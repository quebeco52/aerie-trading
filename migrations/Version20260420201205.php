 ...
 */
final class Version20260420201205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD interest_expense NUMERIC(20, 4) NOT NULL, ADD blended_rate NUMERIC(10, 6) NOT NULL, ADD dynamic_spread NUMERIC(10, 6) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP interest_expense, DROP blended_rate, DROP dynamic_spread');
