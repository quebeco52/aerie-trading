 ...
 */
final class Version20260812123249 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD consumer_sentiment_index DOUBLE PRECISION DEFAULT \'100\' NOT NULL');
