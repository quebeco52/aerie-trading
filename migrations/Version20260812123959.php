 ...
 */
final class Version20260812123959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report CHANGE consumer_sentiment_index consumer_sentiment_index NUMERIC(10, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report CHANGE consumer_sentiment_index consumer_sentiment_index NUMERIC(10, 4) DEFAULT \'100.0000\' NOT NULL');
