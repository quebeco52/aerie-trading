 ...
 */
final class Version20260605100704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD yield2y NUMERIC(10, 4) DEFAULT NULL, ADD yield2y_ema NUMERIC(10, 4) DEFAULT NULL, ADD yield5y NUMERIC(10, 4) DEFAULT NULL, ADD yield5y_ema NUMERIC(10, 4) DEFAULT NULL, ADD yield30y NUMERIC(10, 4) DEFAULT NULL, ADD yield30y_ema NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP yield2y, DROP yield2y_ema, DROP yield5y, DROP yield5y_ema, DROP yield30y, DROP yield30y_ema');
