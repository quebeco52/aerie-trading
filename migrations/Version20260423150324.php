 ...
 */
final class Version20260423150324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD wacc NUMERIC(10, 4) NOT NULL, ADD eva NUMERIC(20, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP wacc, DROP eva');
