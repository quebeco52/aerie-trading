 ...
 */
final class Version20260519231553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD return_on_equity NUMERIC(10, 4) DEFAULT NULL, ADD cost_of_equity NUMERIC(10, 4) DEFAULT NULL, ADD capital_ratio NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP return_on_equity, DROP cost_of_equity, DROP capital_ratio');
