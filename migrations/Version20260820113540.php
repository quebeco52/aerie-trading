 ...
 */
final class Version20260820113540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD residential_property_index NUMERIC(10, 4) NOT NULL, ADD residential_property_index_ema NUMERIC(10, 4) NOT NULL, ADD retail_default_rate NUMERIC(10, 4) NOT NULL, ADD retail_default_rate_ema NUMERIC(10, 4) NOT NULL, ADD agricultural_commodity_index NUMERIC(10, 4) NOT NULL, ADD agricultural_commodity_index_ema NUMERIC(10, 4) NOT NULL, ADD freight_rate_index NUMERIC(10, 4) NOT NULL, ADD freight_rate_index_ema NUMERIC(10, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP residential_property_index, DROP residential_property_index_ema, DROP retail_default_rate, DROP retail_default_rate_ema, DROP agricultural_commodity_index, DROP agricultural_commodity_index_ema, DROP freight_rate_index, DROP freight_rate_index_ema');
