 ...
 */
final class Version20260909111051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD perceived_neutral_rate NUMERIC(10, 4) DEFAULT NULL, ADD restrictive_duration NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP perceived_neutral_rate, DROP restrictive_duration');
