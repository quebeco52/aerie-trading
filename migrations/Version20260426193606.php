 ...
 */
final class Version20260426193606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD dividend_paid NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL, ADD stock_buybacks NUMERIC(20, 4) DEFAULT \'0.0000\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP dividend_paid, DROP stock_buybacks');
