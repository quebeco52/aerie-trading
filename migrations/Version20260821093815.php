 ...
 */
final class Version20260821093815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD capital_stock_overhang NUMERIC(10, 4) NOT NULL, ADD capital_stock_overhang_ema NUMERIC(10, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP capital_stock_overhang, DROP capital_stock_overhang_ema');
