 ...
 */
final class Version20260720184316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report ADD free_cash_flow NUMERIC(20, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report DROP free_cash_flow');
