 ...
 */
final class Version20260505195244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_events CHANGE description description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_events CHANGE description description VARCHAR(255) NOT NULL');
    }
