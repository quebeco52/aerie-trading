 ...
 */
final class Version20260520143138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report CHANGE customer_deposit_ratio customer_deposit_ratio NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE corporate_report CHANGE customer_deposit_ratio customer_deposit_ratio NUMERIC(5, 4) DEFAULT NULL');
