 ...
 */
final class Version20260904191230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD supercore_inflation_ema NUMERIC(10, 4) DEFAULT NULL, ADD core_goods_inflation_ema NUMERIC(10, 4) DEFAULT NULL, ADD cumulative_inflation_gap_ema NUMERIC(10, 4) DEFAULT NULL, ADD high_yield_credit_spread_ema NUMERIC(10, 4) DEFAULT NULL, ADD inventory_stock_gap_ema NUMERIC(10, 4) DEFAULT NULL, ADD energy_inventory_index_ema NUMERIC(10, 4) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP supercore_inflation_ema, DROP core_goods_inflation_ema, DROP cumulative_inflation_gap_ema, DROP high_yield_credit_spread_ema, DROP inventory_stock_gap_ema, DROP energy_inventory_index_ema');
