 ...
 */
final class Version20260812124839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report ADD consumer_sentiment_index_ema NUMERIC(10, 4) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE macro_report DROP consumer_sentiment_index_ema');
