 ...
 */
final class Version20260915152826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX option_expiry ON option_contracts');
        $this->addSql('CREATE INDEX option_status_expiry ON option_contracts (status, expires_at_time)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon_payment CHANGE simulation_time simulation_time DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
        $this->addSql('DROP INDEX option_status_expiry ON option_contracts');
        $this->addSql('CREATE INDEX option_expiry ON option_contracts (expires_at_time)');
