 ...
 */
final class Version20260915193816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etfs ADD expense_ratio NUMERIC(7, 6) DEFAULT \'0.000500\' NOT NULL, ADD basket_per_share NUMERIC(20, 12) DEFAULT \'1.000000000000\' NOT NULL, ADD accrued_income NUMERIC(20, 8) DEFAULT \'0.00000000\' NOT NULL, ADD cumulative_fees_paid NUMERIC(20, 8) DEFAULT \'0.00000000\' NOT NULL, ADD recent_distributions JSON DEFAULT NULL, ADD last_distribution_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon_payment CHANGE simulation_time simulation_time DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE etfs DROP expense_ratio, DROP basket_per_share, DROP accrued_income, DROP cumulative_fees_paid, DROP recent_distributions, DROP last_distribution_at');
        $this->addSql('ALTER TABLE simulation_clock CHANGE total_time total_time DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
