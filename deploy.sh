...
echo -e "\e[33m[2/7] Taking Database Snapshot...\e[0m"
mkdir -p backups
...
echo -e "\e[33m[3/7] Pulling latest code from GitHub...\e[0m"
git pull origin main

echo -e "\e[33m[4/7] Building Immutable Production Images...\e[0m"
$DC build --no-cache aerie-php aerie-worker aerie-scheduler aerie-ticker aerie-websocket aerie-caddy
...
echo -e "\e[33m[6/7] Reigniting the Engines...\e[0m"
$DC up -d aerie-ticker

echo -e "\e[33m[7/7] Sweeping the Hangar (Docker Cleanup)...\e[0m"
