...
class InitialMarket
{
    public const STOCKS = [
        ...
        [
            ...
            'price' => 100.00, 'eps' => 0.10,
            'shares_outstanding' => 1000000000,
            // The Bond Proxy: A defensive yield-trap disguised as a healthcare provider. 
            // Very low beta and steady compounding volatility, but carries a massive negative tail-risk.
