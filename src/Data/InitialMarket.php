...
class InitialMarket
{
    public const STOCKS = [
        [
            ...
            'price' => 2500.00, 'shares_outstanding' => 1_000_000_000,
            'volatility' => 0.15,
            'beta' => 1.10, 'jump_intensity' => 0.40, 'jump_mean' => -0.15, 'jump_vol' => 0.05,
            'baseline_roic' => 0.13,
            'capex_ratio' => 0.10, 'target_payout_ratio' => 0.50, 'dividendSpeed' => 0.07,
            'corporate_treasury' => 150_000_000_000.00, // $150 Billion in liquid cash reserves
            'debt_to_equity' => 1.20, 'operating_margin' => 0.40, 'public_float' => 0.50,
            'total_net_income'  => 208_570_000_000.00,  // Market Cap: $2.5T / PE 14.0
            'total_equity'      => 2_500_000_000_000.00, // $2.5 Trillion Book Value
            'retained_earnings' => 500_000_000_000.00   // Half a trillion in historical survival armor
        ],
        [
            ...
            'baseline_roic' => 0.16,
            'capex_ratio' => 0.05, 'target_payout_ratio' => 0.20, 'dividendSpeed' => 0.40,
            'corporate_treasury' => 80_000_000_000.00, // $80 Billion War Chest for Hostile Takeovers
            'debt_to_equity' => 0.20, 'operating_margin' => 0.45, 'public_float' => 0.50,
            'total_net_income'  => 96_430_000_000.00,  // Market Cap: $1.35T / PE 14.0
            'total_equity'      => 600_000_000_000.00, // $600 Billion Book Value
        ...
        [
            ...
            'total_net_income'  => 22_920_000_000.00,  // Market Cap: 550B / PE 24.0
        ...
        [
            ...
            'price' => 480.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 34_290_000_000.00,  // Market Cap: 480B / PE 14.0
        ...
        [
            ...
            'price' => 450.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 32_140_000_000.00,  // Market Cap: 450B / PE 14.0
        ...
        [
            ...
            'price' => 650.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 46_430_000_000.00,  // Market Cap: 650B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 8_210_000_000.00,   // Market Cap: 115B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 19_290_000_000.00,  // Market Cap: 270B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 11_430_000_000.00,  // Market Cap: 160B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 15_000_000_000.00,  // Market Cap: 210B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 9_380_000_000.00,   // Market Cap: 150B / PE 16.0
        ...
        [
            ...
            'total_net_income'  => 9_000_000_000.00,   // Market Cap: 180B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 8_000_000_000.00,   // Market Cap: 120B / PE 15.0
        ...
        [
            ...
            'total_net_income'  => 6_040_000_000.00,   // Market Cap: 145B / PE 24.0
        ...
        [
            ...
            'total_net_income'  => 5_680_000_000.00,   // Market Cap: 125B / PE 22.0
        ...
        [
            ...
            'total_net_income'  => 12_500_000_000.00,  // Market Cap: 250B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 7_750_000_000.00,   // Market Cap: 155B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 11_180_000_000.00,  // Market Cap: 190B / PE 17.0
        ...
        [
            ...
            'total_net_income'  => 10_560_000_000.00,  // Market Cap: 190B / PE 18.0
        ...
        [
            ...
            'total_net_income'  => 13_500_000_000.00,  // Market Cap: 270B / PE 20.0
        ...
        [
            ...
            'price' => 200.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 8_330_000_000.00,   // Market Cap: 200B / PE 24.0
        ...
        [
            ...
            'total_net_income'  => 8_570_000_000.00,   // Market Cap: 120B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 7_860_000_000.00,   // Market Cap: 110B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 5_240_000_000.00,   // Market Cap: 110B / PE 21.0
        ...
        [
            ...
            'total_net_income'  => 8_130_000_000.00,   // Market Cap: 130B / PE 16.0
        ...
        [
            ...
            'total_net_income'  => 6_250_000_000.00,   // Market Cap: 125B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 7_630_000_000.00,   // Market Cap: 145B / PE 19.0
            'total_equity'      => 42_390_000_000.00,
            'retained_earnings' => 15_000_000_000.00
        ],
        [
            'ticker' => 'TALN', 'name' => 'Talon Credit', 'sector' => 'Financials', 'systemic_importance' => 'none',
            'price' => 165.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 11_790_000_000.00,  // Market Cap: 165B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 8_750_000_000.00,   // Market Cap: 175B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 6_110_000_000.00,   // Market Cap: 110B / PE 18.0
        ...
        [
            ...
            'total_net_income'  => 5_500_000_000.00,   // Market Cap: 110B / PE 20.0
        ...
        [
            ...
            'total_net_income'  => 5_710_000_000.00,   // Market Cap: 80B / PE 14.0
        ...
        [
            ...
            'total_net_income'  => 8_180_000_000.00,   // Market Cap: 180B / PE 22.0
        ...
        [
            ...
            'total_net_income'  => 5_000_000_000.00,   // Market Cap: 105B / PE 21.0
        ...
        [
            ...
            'total_net_income'  => 4_900_000_000.00,   // Market Cap: 103B / PE 21.0
        ...
        [
            ...
            'total_net_income'  => 11_900_000_000.00,  // Market Cap: 250B / PE 21.0
        ...
        [
            ...
            'total_net_income'  => 10_000_000_000.00,  // Market Cap: 180B / PE 18.0
            'total_equity'      => 100_000_000_000.00,
            'retained_earnings' => 60_000_000_000.00
        ],
        [
            'ticker' => 'BRKW', 'name' => 'Breakwater Trust', 'sector' => 'Financials', 'systemic_importance' => 'titan',
            'price' => 850.00, 'shares_outstanding' => 1_000_000_000,
            'volatility' => 0.10, 'beta' => 0.40, 'jump_intensity' => 0.30, 'jump_mean' => 0.04, 'jump_vol' => 0.09,
            'baseline_roic' => 0.0607, // 6.07% ROIC (Bloated, hidden yield)
            'capex_ratio' => 0.10, 'target_payout_ratio' => 0.25, 'dividendSpeed' => 0.20,
            'corporate_treasury' => 38_000_000_000.00, 'debt_to_equity' => 0.50, 'operating_margin' => 0.40, 
            'public_float' => 0.40, // The Family strictly holds 60% of the voting power
            'total_net_income'  => 60_710_000_000.00,   // Market Cap: $850B / PE 14.0
            'total_equity'      => 1_000_000_000_000.00, // $1 Trillion Book Value (Trading at a 15% Discount!)
            'retained_earnings' => 600_000_000_000.00   // A century of hoarded, old-money wealth
        ],
        [
            ...
            'total_net_income'  => 7_890_000_000.00,   // Market Cap: 150B / PE 19.0
        ...
        [
            ...
            'price' => 135.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 7_500_000_000.00,   // Market Cap: 135B / PE 18.0
        ...
        [
            ...
            'total_net_income'  => 10_000_000_000.00,  // Market Cap: 210B / PE 21.0
        ...
        [
            ...
            'total_net_income'  => 16_430_000_000.00,  // Market Cap: 230B / PE 14.0
        ...
        [
            ...
            'price' => 250.00, 'shares_outstanding' => 1_000_000_000,
            'volatility' => 0.32, 'beta' => 1.45, 'jump_intensity' => 0.60, 'jump_mean' => -0.11, 'jump_vol' => 0.15,
            'baseline_roic' => 0.14, 'capex_ratio' => 0.85, 'target_payout_ratio' => 0.10, 'dividendSpeed' => 0.40,
            'corporate_treasury' => 1_200_000_000.00, 'debt_to_equity' => 2.50, 'operating_margin' => 0.16, 'public_float' => 0.92,
            'total_net_income'  => 16_670_000_000.00,  // Market Cap: 250B / PE 15.0
        ...
        [
            ...
            'price' => 290.00, 'shares_outstanding' => 1_000_000_000,
            ...
            'total_net_income'  => 12_080_000_000.00,  // Market Cap: 290B / PE 24.0
