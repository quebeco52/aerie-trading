...
class InitialMarket
{
    public const STOCKS = [
        [
            ...
            'baseline_roic' => 0.30, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.50 // Steady bank, high dividend
        ],
        [
            ...
            'baseline_roic' => 0.25, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.20 // Capital-light predator, hoards cash for M&A
        ],
        [
            ...
            'baseline_roic' => 0.30, 'capex_ratio' => 0.25, 'target_payout_ratio' => 0.15 // High ROIC software monopoly, moderate data-center CapEx
        ],
        [
            ...
            'baseline_roic' => 0.18, 'capex_ratio' => 0.02, 'target_payout_ratio' => 0.40 // Value investor, no factories, pays out cash
        ],
        [
            ...
            'baseline_roic' => 0.22, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.30
        ],
        [
            ...
            'baseline_roic' => 0.35, 'capex_ratio' => 0.15, 'target_payout_ratio' => 0.60 // High frequency options clearing, massive margins
        ],
        [
            ...
            'baseline_roic' => 0.14, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.30
        ],
        [
            ...
            'baseline_roic' => 0.10, 'capex_ratio' => 0.02, 'target_payout_ratio' => 0.70 // Reinsurance pays huge dividends, almost zero CapEx
        ],
        [
            ...
            'baseline_roic' => 0.12, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.60
        ],
        [
            ...
            'baseline_roic' => 0.40, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.80 // Untouchable monopoly, prints cash, no physical assets
        ],
        [
            ...
            'baseline_roic' => 0.08, 'capex_ratio' => 0.75, 'target_payout_ratio' => 0.60 // Regulated utility: low ROIC, massive CapEx (power plants), steady dividend
        ],
        [
            ...
            'baseline_roic' => 0.18, 'capex_ratio' => 0.20, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.10, 'capex_ratio' => 0.65, 'target_payout_ratio' => 0.20 // Blast furnaces require relentless CapEx
        ],
        [
            ...
            'baseline_roic' => 0.22, 'capex_ratio' => 0.50, 'target_payout_ratio' => 0.00 // Hyper-growth hardware. $0 dividend.
        ],
        [
            ...
            'baseline_roic' => 0.12, 'capex_ratio' => 0.60, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.20, 'capex_ratio' => 0.40, 'target_payout_ratio' => 0.15 // Robotics manufacturing
        ],
        [
            ...
            'baseline_roic' => 0.15, 'capex_ratio' => 0.25, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.12, 'capex_ratio' => 0.55, 'target_payout_ratio' => 0.65 // Massive fiber network CapEx, reliable dividend
        ],
        [
            ...
            'baseline_roic' => 0.35, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.80 // Tobacco cash cow. Huge margins, minimal capex.
        ],
        [
            ...
            'baseline_roic' => 0.14, 'capex_ratio' => 0.35, 'target_payout_ratio' => 0.45
        ],
        [
            ...
            'baseline_roic' => 0.10, 'capex_ratio' => 0.70, 'target_payout_ratio' => 0.20 // Concrete and cranes burn massive cash
        ],
        [
            ...
            'baseline_roic' => 0.45, 'capex_ratio' => 0.15, 'target_payout_ratio' => 0.30 // SaaS data monopoly. Incredible 45% ROIC
        ],
        [
            ...
            'baseline_roic' => 0.15, 'capex_ratio' => 0.80, 'target_payout_ratio' => 0.25 // Offshore drilling requires massive continuous CapEx
        ],
        [
            ...
            'baseline_roic' => 0.18, 'capex_ratio' => 0.40, 'target_payout_ratio' => 0.35
        ],
        [
            ...
            'baseline_roic' => 0.16, 'capex_ratio' => 0.30, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.14, 'capex_ratio' => 0.45, 'target_payout_ratio' => 0.75
        ],
        [
            ...
            'baseline_roic' => 0.20, 'capex_ratio' => 0.35, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.18, 'capex_ratio' => 0.25, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.25, 'capex_ratio' => 0.15, 'target_payout_ratio' => 0.35
        ],
        [
            ...
            'baseline_roic' => 0.12, 'capex_ratio' => 0.55, 'target_payout_ratio' => 0.30 // Large truck fleets require high CapEx
        ],
        [
            ...
            'baseline_roic' => 0.22, 'capex_ratio' => 0.15, 'target_payout_ratio' => 0.60
        ],
        [
            ...
            'baseline_roic' => 0.20, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.25, 'capex_ratio' => 0.35, 'target_payout_ratio' => 0.45
        ],
        [
            ...
            'baseline_roic' => 0.50, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.80 // Law firms have no hard assets. Infinite ROIC.
        ],
        [
            ...
            'baseline_roic' => 0.40, 'capex_ratio' => 0.20, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.08, 'capex_ratio' => 0.20, 'target_payout_ratio' => 0.90 // REITs are legally required to distribute 90%
        ],
        [
            ...
            'baseline_roic' => 0.30, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.60
        ],
        [
            ...
            'baseline_roic' => 0.15, 'capex_ratio' => 0.30, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.22, 'capex_ratio' => 0.45, 'target_payout_ratio' => 0.00 // Reinvests every penny to maintain monopoly
        ],
        [
            ...
            'baseline_roic' => 0.10, 'capex_ratio' => 0.60, 'target_payout_ratio' => 0.30
        ],
        [
            ...
            'baseline_roic' => 0.12, 'capex_ratio' => 0.10, 'target_payout_ratio' => 0.25
        ],
        [
            ...
            'baseline_roic' => 0.16, 'capex_ratio' => 0.40, 'target_payout_ratio' => 0.70
        ],
        [
            ...
            'baseline_roic' => 0.28, 'capex_ratio' => 0.15, 'target_payout_ratio' => 0.65 // Master franchise: franchisees pay the capex, SWFT just collects rent
        ],
        [
            ...
            'baseline_roic' => 0.30, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.08, 'capex_ratio' => 0.85, 'target_payout_ratio' => 0.00 // Gigafactories burn massive cash, $0 dividend
        ],
        [
            ...
            'baseline_roic' => 0.25, 'capex_ratio' => 0.20, 'target_payout_ratio' => 0.40
        ],
        [
            ...
            'baseline_roic' => 0.35, 'capex_ratio' => 0.05, 'target_payout_ratio' => 0.50
        ],
        [
            ...
            'baseline_roic' => 0.14, 'capex_ratio' => 0.75, 'target_payout_ratio' => 0.10 // Heavy machinery, extreme CapEx
        ],
        [
            ...
            'baseline_roic' => 0.18, 'capex_ratio' => 0.80, 'target_payout_ratio' => 0.15 // Fab plants are the most expensive buildings on earth
        ],
    ];
